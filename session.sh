...
tmux send-keys -t ${window}.1 'cd angular-FE && grunt build && npm start' Enter
tmux send-keys -t ${window}.2 'cd sinatra-BE && ruby app.rb' Enter
tmux send-keys -t ${window}.3 'node localtunnel.js' Enter
